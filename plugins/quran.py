...
async def fares2(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ⌯", callback_data="fares " + str(m.from_user.id))],
        [InlineKeyboardButton("القائمه الرئيسيه ⌯", callback_data="quran2 " + str(m.from_user.id))],
        [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك ⌯", url=f"https://t.me/{get_bot_information()[1]}?startgroup=new")],
...
async def naser2(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ⌯", callback_data="naser " + str(m.from_user.id))],
        [InlineKeyboardButton("القائمه الرئيسيه ⌯", callback_data="quran2 " + str(m.from_user.id))],
        [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك ⌯", url=f"https://t.me/{get_bot_information()[1]}?startgroup=new")],
...
async def eslam2(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ⌯", callback_data="eslam " + str(m.from_user.id))],
        [InlineKeyboardButton("القائمه الرئيسيه ⌯", callback_data="quran2 " + str(m.from_user.id))],
        [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك ⌯", url=f"https://t.me/{get_bot_information()[1]}?startgroup=new")],
...
async def abdelbaset2(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ⌯", callback_data="abdelbaset " + str(m.from_user.id))],
        [InlineKeyboardButton("القائمه الرئيسيه ⌯", callback_data="quran2 " + str(m.from_user.id))],
        [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك ⌯", url=f"https://t.me/{get_bot_information()[1]}?startgroup=new")],
...
async def eldosary2(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ⌯", callback_data="eldosary " + str(m.from_user.id))],
        [InlineKeyboardButton("القائمه الرئيسيه ⌯", callback_data="quran2 " + str(m.from_user.id))],
        [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك ⌯", url=f"https://t.me/{get_bot_information()[1]}?startgroup=new")],
...
async def abkar2(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ⌯", callback_data="abkar " + str(m.from_user.id))],
        [InlineKeyboardButton("القائمه الرئيسيه ⌯", callback_data="quran2 " + str(m.from_user.id))],
        [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك ⌯", url=f"https://t.me/{get_bot_information()[1]}?startgroup=new")],
...
async def afasy2(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ⌯", callback_data="afasy " + str(m.from_user.id))],
        [InlineKeyboardButton("القائمه الرئيسيه ⌯", callback_data="quran2 " + str(m.from_user.id))],
        [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك ⌯", url=f"https://t.me/{get_bot_information()[1]}?startgroup=new")],
...
async def agamy2(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ⌯", callback_data="agamy " + str(m.from_user.id))],
        [InlineKeyboardButton("القائمه الرئيسيه ⌯", callback_data="quran2 " + str(m.from_user.id))],
        [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك ⌯", url=f"https://t.me/{get_bot_information()[1]}?startgroup=new")],
...
async def maher2(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ⌯", callback_data="maher " + str(m.from_user.id))],
        [InlineKeyboardButton("القائمه الرئيسيه ⌯", callback_data="quran2 " + str(m.from_user.id))],
        [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك ⌯", url=f"https://t.me/{get_bot_information()[1]}?startgroup=new")],
...
async def galel2(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجوع ⌯", callback_data="galel " + str(m.from_user.id))],
        [InlineKeyboardButton("القائمه الرئيسيه ⌯", callback_data="quran2 " + str(m.from_user.id))],
        [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك ⌯", url=f"https://t.me/{get_bot_information()[1]}?startgroup=new")],
