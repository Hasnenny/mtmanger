...
async def moderngame(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    newgames = "بعض الالعاب المتطوره اختر لعبه وم ثم اختر الشات الذي ترغب باللعب به"
...
async def games2(c: Client, m: CallbackQuery):
    ...
    await m.message.edit_text("⌯ أهلا بيك بقائمه العاب سورس الفالكيري قم باختيار احذى الازرار\n√", reply_markup=keyboard)
